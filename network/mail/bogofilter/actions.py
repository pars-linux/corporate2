...
def install():
    ...
    pisitools.dodoc("AUTHORS", "COPYING", "gpl-3.0.txt", "NEWS*", "README", "RELEASE.NOTES*", "TODO", "GETTING.STARTED", "doc/integrating-with-*", "contrib/bogofilter-qfe.sh", "contrib/bogofilter-milter.pl", "contrib/dot-qmail-bogofilter-default", "contrib/*.example", "contrib/parmtest.sh", "contrib/README.*", "contrib/randomtrain.sh", "contrib/scramble.sh")
