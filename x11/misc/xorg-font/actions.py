...
# Trailing slash is important since it is used with dosed in install.
encodingsDir = "/usr/share/fonts/encodings/"

def setup():
    for package in shelltools.ls("*-*"):
        shelltools.cd(package)
        autotools.configure("--with-encodingsdir=%s \
                             --with-mapfiles=/usr/share/fonts/util \
                             --with-top-fontdir=/usr/share/fonts" % encodingsDir)
        shelltools.cd("../")
...
def install():
    ...
    pisitools.remove("/usr/share/fonts/*/fonts.scale")
